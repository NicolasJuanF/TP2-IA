...
public class Conversion {
	private static final String conAcentos = "¡·…ÈÕÌ”Û⁄˙—Ò‹¸";
	private static final String sinAcentos = "AaEeIiOoUuNnUu";
	...
	public static String normalizar(String oracion){
	    ...
	    for (int i = 0; i < temporal.length; i++) {
	        int pos = conAcentos.indexOf(temporal[i]);
	        if (pos > -1) {
	        	temporal[i] = sinAcentos.charAt(pos);
	        }
